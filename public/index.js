...
gui.add(config, 'width', 0, window.innerWidth * window.devicePixelRatio * 2).name('Width');
gui.add(config, 'height', 0, window.innerHeight * window.devicePixelRatio * 2).name('Height');
...
gui.add(config, 'steps', 1, 10).step(1).name('Steps');
...
const system = window.system = new System(WIDTH, HEIGHT, STIFFNESS, VISCOSITY, SURFACE_TENSION, GRAVITY, PARTICLE_COUNT, STEPS, canvas);
